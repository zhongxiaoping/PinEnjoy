  ...
  <div>
    <form id="signup" class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="accountNickname" placeholder="用户名">
        </div>
        <input type="hidden" id="sessionId" value="${pageContext.session.id}"/>
      </div>
      <div class="form-group">
        <label for="thumb" class="col-sm-2 control-label">上传头像</label>
        <div class="col-sm-10">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="email" class="form-control" id="accountEmail" value="邮箱">
        </div>
      </div>
      <div class="form-group calendar">
        <label for="accountBirthday" class="col-sm-2 control-label">出生日</label>
        <div class="col-sm-10">
          <input type="text" class="laydate-icon" id="accountBirthday" value="1993-6-30">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <textarea class="form-control" rows="3" id="accountResume" value="accountResume"></textarea>
        </div>
      </div>
      <div class="form-group" style="text-align: center;">
        <button type="button" class="btn btn-primary" onclick="$('#thumb').uploadify('upload','*')">
          提交
        </button>
      </div>
    </form>
  ...
  $(function() {
    $("#thumb").uploadify({
      ...
      'onUploadStart' : function(file) {
        var accountNickname = $('#accountNickname').text(),
                ...
                accountBirthday = $('#accountBirthday').val();

        alert(accountNickname);
        alert(accountEmail);

        $('#thumb').uploadify("settings", "formData", {
