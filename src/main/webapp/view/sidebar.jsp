        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="form-group">
                <label for="image_description" class="control-label">图片描述</label>
                <textarea class="form-control" id="image_description"></textarea>
              </div>
              <div>
              ...
              <span style="height: 55px; margin-left: 25px;vertical-align: middle;"><input type="checkbox" value="1" id="autoDelete"> 阅后即焚？</span>
            </form>
          </div>
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" onclick="$('#_uploadFile').uploadify('stop','*')" disabled="disabled" id="stopUpload">停止上传</button>
          </div>
        </div>
      </div>
    </div>
